...
var zPos5:float;
var xPos:float;
var carFiveSpeed:float;

var Accel:float = 0.001;
var movingState:int;
var carsCounter:int;

var carFiveBody:GameObject;
var carFiveBody1:GameObject;
var carFiveBody2:GameObject;
var carFiveBody3:GameObject;
...
public var car5State:boolean = false;

function Start () {
		
		carFiveBody = GameObject.Find("ClassicCbody");
		carFiveBody1 = GameObject.Find("ClassicCbody1");
		carFiveBody2 = GameObject.Find("ClassicCbody2");
		carFiveBody3 = GameObject.Find("ClassicCbody3");
		
		leftWheel = GameObject.Find("ClassicLeftWheel");
		leftWheel1 = GameObject.Find("ClassicLeftWheel1");
		leftWheel2 = GameObject.Find("ClassicLeftWheel2");
		leftWheel3 = GameObject.Find("ClassicLeftWheel3");
		
		rightWheel = GameObject.Find("ClassicRightWheel");
		rightWheel1 = GameObject.Find("ClassicRightWheel1");
		rightWheel2 = GameObject.Find("ClassicRightWheel2");
		rightWheel3 = GameObject.Find("ClassicRightWheel3");
...
function Update () {
		...
		if(car5State == true)
		{
			...
			{
				zPos5 = -0.44;
				this.transform.position.z = zPos5;
			}
			if (CarlaneNum == 1)
			{
				zPos5 = 0;
			...
			if (CarlaneNum == 2)
			{
				...
				this.transform.position.z = zPos5;
				this.transform.Translate(carFiveSpeed,0,0);
				CarFiveWheelsRotation();
			}
		}
...
function changeColour()
{
	...
	carFiveBody.GetComponent.<Renderer>().material.color = Color(Random.Range(0.0,1.0),Random.Range(0.0,1.0), Random.Range(0.0,1.0));
	carFiveBody1.GetComponent.<Renderer>().material.color = Color(Random.Range(0.0,1.0),Random.Range(0.0,1.0), Random.Range(0.0,1.0));
	carFiveBody2.GetComponent.<Renderer>().material.color = Color(Random.Range(0.0,1.0),Random.Range(0.0,1.0), Random.Range(0.0,1.0));
	carFiveBody3.GetComponent.<Renderer>().material.color = Color(Random.Range(0.0,1.0),Random.Range(0.0,1.0), Random.Range(0.0,1.0));
}
function CarFiveWheelsRotation()
{
